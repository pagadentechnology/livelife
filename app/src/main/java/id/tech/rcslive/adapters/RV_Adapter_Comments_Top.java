 ...
 */
public class RV_Adapter_Comments_Top extends RecyclerView.Adapter<RV_Adapter_Comments_Top.ViewHolder>{
    private List<Rowdata_Comment> objects;
    private Context context;

    public RV_Adapter_Comments_Top(List<Rowdata_Comment> objects, Context context) {
