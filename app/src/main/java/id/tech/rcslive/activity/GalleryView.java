...
import id.tech.rcslive.adapters.RV_Adapter_GalleryView;
import id.tech.rcslive.models.RowDataGallery;

/**
 * Created by macbook on 4/22/16.
 */
public class GalleryView extends AppCompatActivity implements RV_Adapter_GalleryView.onSelectedImageInterface {
    RecyclerView rv ;
    ...
    private class Async_LoadGallery extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            adapter = new RV_Adapter_GalleryView(activity, getApplicationContext(), data);
